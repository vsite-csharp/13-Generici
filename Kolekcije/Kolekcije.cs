namespace Vsite.CSharp.Generici
{
    ...
    internal static class GeneričkeKolekcije
    {
        ...
        static void Main()
        {
            ...
            jsv.DodajJelo(new Osoba("Ivica", new DateTime(2024, 1, 1)));
            jsv.DodajJelo(new Osoba("Marica", new DateTime(2024, 1, 2)));

            // :004 Prevesti program, pokrenuti ga i provjeriti ispis.
            // :005 Pokrenuti i provjeriti testove (Oba testa u grupi "GeneričkeKolekcije" moraju proći)
