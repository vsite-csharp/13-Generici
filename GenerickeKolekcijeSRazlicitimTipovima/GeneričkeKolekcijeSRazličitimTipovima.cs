...
namespace Vsite.CSharp.Generici
{
    class GeneričkeKolekcijeSaČlanovimaRazličitihTipova
    {
        public static void KretanjeŽivotinja()
        {
            ...
            // :011 Klasu ArrayList nadomjestiti generičkom listom List<Životinja>. Otkomentirati naredbu u petlji, prevesti program i provjeriti da nema pogrešaka.
            var živine = new List<Životinja>(); // jer je životinja bazni možemo ih sve tako dodavati
        ...
        // :012 Pokrenuti i provjeriti testove (test u grupi "GeneričkeKolekcijeSaČlanovimaRazličitihTipova" mora proći)
