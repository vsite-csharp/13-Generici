...
namespace Vsite.CSharp.Generici
{
    class GeneričkeKolekcijeSRazličitimParametrima
    {
        public static void PridruživanjeDvijuKolekcijaSIstimParametrima()
        {
            ...
            Dictionary<string, int> mojiBrojevi = new Dictionary<string, int>(brojevi);
            foreach (var e in mojiBrojevi)
            {
                Console.WriteLine($@"""{e.Key}"" = {e.Value}");
            }
        ...
        //  Pokrenuti i provjeriti testove (test u grupi "GeneričkeKolekcijeSRazličitimParametrima" mora proći)
