...
namespace Vsite.CSharp.Generici
{
    ...
    class OsobaPoVisini : IComparable<OsobaPoVisini>    //dodano : IComparable<OsobaPoVisini> 
    {
        ...
        public int CompareTo(OsobaPoVisini other)   //dodano
        {
    ...
    class OgraničenjeParametra
    {
        ...
        public static T Manji<T>(T prvi, T drugi) where T: IComparable<T>   //dodano where T: IComparable<T>
        {
            return prvi.CompareTo(drugi) < 0 ? prvi : drugi;        //dodano
        }
