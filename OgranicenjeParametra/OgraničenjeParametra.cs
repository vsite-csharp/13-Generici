...
namespace Vsite.CSharp.Generici
{
    ...
    internal class OsobaPoVisini : IComparable<OsobaPoVisini>
    {
    ...
    {
        // 030 Definirati metodu Manji tako da vraća manji od dva proslijeđena argumenta pozivom njihove metode CompareTo iz sučelja IComparable<T>.
        ...
        // 031 Pokrenuti program i provjeriti ispis.

        // 032 Pokrenuti testove (3 testa u grupi "TestOgraničenjaParametra" moraju proći)
